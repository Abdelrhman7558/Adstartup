...
export default function MetaSelect() {
  ...
  const SelectionList = ({ items, selected, onSelect, onClear, isLoading, customEmpty }: any) => (
            ...
            {currentStep === 4 && (
              ...
              >
                <SelectionList
                  ...
                  customEmpty={
                    !loading && (
                      <div className="mt-4 p-8 bg-yellow-900/30 border border-yellow-700/50 rounded-xl text-center">
                        <p className="text-yellow-400 text-sm mb-4">No Instagram account found for this page.</p>
                        <p className="text-gray-400 text-xs">You can proceed without one by clicking Next, but your ads may only run on Facebook.</p>
                      </div>
                    )
                  }
                />
