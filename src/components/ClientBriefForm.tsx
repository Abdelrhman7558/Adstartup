    ...
    <div className="space-y-6">
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-red-500 dark:bg-slate-700 dark:text-white"
          required
        />
      </div>
      ...
      <div>
        ...
        {formData.business_type === 'Other' && (
          <input
            ...
            className="w-full px-4 py-2 mt-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-red-500 dark:bg-slate-700 dark:text-white"
