                ...
                <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="relative hidden sm:flex items-center">
                        ...
                        <input
                            type="text"
                            placeholder="Search..."
                            className="pl-9 pr-12 py-2 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all w-64"
                        />
