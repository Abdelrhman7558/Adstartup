...
type ActionType = 'kill' | 'remove' | 'pause' | 'activate' | 'kill-all' | 'duplicate' | 'optimize' | 'scale';
  ...
  const getActionDetails = () => {
    switch (actionType) {
      ...
      case 'duplicate':
        return {
          title: 'Duplicate Ad',
          description: `Are you sure you want to duplicate "${ad?.name}"? A webhook will be triggered.`,
      ...
      case 'optimize':
        return {
          title: 'Optimize Ad',
          description: `Are you sure you want to optimize "${ad?.name}"? A webhook will be triggered.`,
      ...
      case 'scale':
        return {
          title: 'Scale Ad',
          description: `Are you sure you want to scale "${ad?.name}"? A webhook will be triggered.`,
          confirmText: 'Scale',
          dangerLevel: 'low',
        };
      default:
