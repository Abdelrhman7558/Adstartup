...
import { CampaignMetrics } from '../../lib/dashboardDataService';
...
export default function TopProfitableCampaigns({ campaigns = [], isLoading = false }: TopProfitableCampaignsProps) {
          ...
          {topCampaigns.map((campaign, index) => {
            ...
            return (
              ...
              >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 mt-1">
                        <span className={`text-xs ${
                          ...
                          ROAS: {roas === 0 || roas === "-" ? "-" : `${typeof roas === 'number' ? roas.toFixed(2) : '-'}x`}
                        </span>
                        <span className={`text-xs ${
                          theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                        }`}>
                          Spend: {spend === "-" ? "-" : `$${spend.toLocaleString()}`}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                {/* Profit bar */}
                <div className={`h-2 rounded-full overflow-hidden mt-3 ${
